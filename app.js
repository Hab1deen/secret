...
mongoose.connect("mongodb+srv://"+process.env.DB_USERNAME+":"+process.env.DB_PASSWORD+"@cluster0.zdildfk.mongodb.net/UserDB?retryWrites=true&w=majority&ssl=true"); // SQL: Create DB
